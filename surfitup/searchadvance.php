...
<head>
	...
	<title>Surf It Up! Advanced Search.</title>
		...
		<div class="container">
		  <div class="row">
			<div class="col-xl-9 mx-auto">
			  ...
			  <p class="mb-3">Enter location, wind speed, water temp and tide.</p>
			</div>
			<div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
			
			<!-- send input to searchresults.php -->
			  <form action="searchadvanceresults.php" method="get">
				<div class="form-row">
				...
				<div class="form-row">
				  <div class="col-12 col-md-12">
					<p class="inputknot">Tide:</p>
					<input style="text-align: center;" name="tide" id="tide" type="textbox" class="form-control form-control-lg" value="0" required></input>
				  </div>
				</div>
			  </form>
			</div>
